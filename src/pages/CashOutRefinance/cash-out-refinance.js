            ...
            <div className='purchaseBottomParent'>
                <div className='purchaseBottomBox'>
                    <div className='purchaseBottomLeftBox'>
                        ...
                        <span className='purchaseBottomLeftContent'>If you are looking for this type of refinancing, Prime Home Mortgage, INC can find a program suited to your financial needs. We offer cash-out programs for Owner-occupied homes and Non-owner occupied homes, with low, affordable rates.</span>
