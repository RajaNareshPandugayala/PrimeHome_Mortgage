...
function ChatBotPurchase() {
    ...
    function handleSubmit(event) {
        ...
        const scriptURL = "https://script.google.com/macros/s/AKfycbwYW4USsffQJcxexwjKvDG2zN_JQ5EttJOPPZn6Rw4V-1zgosRiGh5eH_mHxkzDpYA/exec"; // Replace with your Web App URL
        ...
        <div className='ChartBotPurchaseBox ChartBotBothBox'>
            <form className='ChartBotForm' target="_self" action="https://formsubmit.co/rajanaresh.p@gmail.com" method="POST" onSubmit={handleSubmit}>
                ...
                <span className={`ChartBotFormSpan ${currentStep === 0 ? 'active' : ''}`}>
                    <label>
                        <h3 className='ChartBotFormSpan_H3Tag'>Instant Home Purchase Analysis</h3>
                ...
                <span className={`ChartBotFormSpan ${currentStep === 1 ? 'active' : ''}`}>
                    <label>
                        <h3 className='ChartBotFormSpan_H3Tag'>What type of property is it?</h3>
                ...
                <span className={`ChartBotFormSpan ${currentStep === 2 ? 'active' : ''}`}>
                    <label>
                        <h3 className='ChartBotFormSpan_H3Tag'>Are You a First Time Homebuyer?</h3>
                ...
                <span className={`ChartBotFormSpan ${currentStep === 3 ? 'active' : ''}`}>
                    <label>
                        <h3 className='ChartBotFormSpan_H3Tag'>What stage of the process are you in?</h3>
                ...
                <span className={`ChartBotFormSpan ${currentStep === 4 ? 'active' : ''}`}>
                    <label >
                        <h3 className='ChartBotFormSpan_H3Tag'>What is the Purchase Price?</h3>
                ...
                <span className={`ChartBotFormSpan ${currentStep === 5 ? 'active' : ''}`}>
                    <label>
                        <h3 className='ChartBotFormSpan_H3Tag'>What do you think your down payment percent % will be?
                        </h3>
                        <p className='ChartBotFormSpan_PTag'>(estimate ok)</p>
                ...
                <span className={`ChartBotFormSpan ${currentStep === 6 ? 'active' : ''}`}>
                    <label>
                        <h3 className='ChartBotFormSpan_H3Tag'>What is your credit score?</h3>
                ...
                <span className={`ChartBotFormSpan ${currentStep === 7 ? 'active' : ''}`}>
                    <label>
                        <h3 className='ChartBotFormSpan_H3Tag'>What is your gross (before taxes) annual household income
                        </h3>
                ...
                <span className={`ChartBotFormSpan ${currentStep === 8 ? 'active' : ''}`}>
                    <label>
                        <h3 className='ChartBotFormSpan_H3Tag'>What is your employment status?</h3>
                ...
                <span className={`ChartBotFormSpan ${currentStep === 10 ? 'active' : ''}`}>
                    <label>
                        <h3 className='ChartBotFormSpan_H3Tag'>Can you show proof of income?</h3>
                ...
                <span className={`ChartBotFormSpan ${currentStep === 11 ? 'active' : ''}`}>
                    <label>
                        <h3 className='ChartBotFormSpan_H3Tag'>Are you working with a real estate agent?</h3>
                ...
                <span className={`ChartBotFormSpan ${currentStep === 12 ? 'active' : ''}`}>
                    <label>
                        <h3 className='ChartBotFormSpan_H3Tag'>Real Estate Agent Name</h3>
                ...
                <span className={`ChartBotFormSpan ${currentStep === 13 ? 'active' : ''}`}>
                    <label>
                        <h3 className='ChartBotFormSpan_H3Tag'>Are you working with a Loan Officer?</h3>
                ...
                <span className={`ChartBotFormSpan ${currentStep === 14 ? 'active' : ''}`}>
                    <label>
                        <h3 className='ChartBotFormSpan_H3Tag'>Select Loan Officer</h3>
                ...
                <span className={`ChartBotFormSpan ${currentStep === 15 ? 'active' : ''}`}>
                    <label>
                        <h3 className='ChartBotFormSpan_H3Tag'>Your First Name</h3>
                ...
                <span className={`ChartBotFormSpan ${currentStep === 16 ? 'active' : ''}`}>
                    <label>
                        <h3 className='ChartBotFormSpan_H3Tag'>Your Last Name</h3>
                ...
                <span className={`ChartBotFormSpan ${currentStep === 17 ? 'active' : ''}`}>
                    <label>
                        <h3 className='ChartBotFormSpan_H3Tag'>What is your email</h3>
