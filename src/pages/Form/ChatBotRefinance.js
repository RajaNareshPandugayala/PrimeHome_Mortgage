        ...
        <div className='ChartBotRefinanceBox ChartBotBothBox'>
            <form className='ChartBotForm' target="_self" action="https://formsubmit.co/rajanaresh.p@gmail.com" method="POST" onSubmit={handleSubmit}>
                ...
                <span className={`ChartBotFormSpan ${currentStep === 2 ? 'active' : ''}`}>
                    <label>
                        <h3 className='ChartBotFormSpan_H3Tag'>What is the estimated value of the property?</h3>
                ...
                <span className={`ChartBotFormSpan ${currentStep === 3 ? 'active' : ''}`}>
                    <label>
                        <h3 className='ChartBotFormSpan_H3Tag'>How will you use the property?</h3>
                ...
                <span className={`ChartBotFormSpan ${currentStep === 4 ? 'active' : ''}`}>
                    <label>
                        <h3 className='ChartBotFormSpan_H3Tag'>What is remaining balance on the 1st mortgage?</h3>
                        <p className='ChartBotFormSpan_PTag'>(estimate ok)</p>
                ...
                <span className={`ChartBotFormSpan ${currentStep === 5 ? 'active' : ''}`}>
                    <label>
                        <h3 className='ChartBotFormSpan_H3Tag'>What is your first mortgage interest rate?</h3>
                        <p className='ChartBotFormSpan_PTag'>(estimate ok)</p>
                ...
                <span className={`ChartBotFormSpan ${currentStep === 6 ? 'active' : ''}`}>
                    <label>
                        <h3 className='ChartBotFormSpan_H3Tag'>What type of rate is it?</h3>
                ...
                <span className={`ChartBotFormSpan ${currentStep === 8 ? 'active' : ''}`}>
                    <label>
                        <h3 className='ChartBotFormSpan_H3Tag'>Would you like to borrow additional cash?</h3>
                ...
                <span className={`ChartBotFormSpan ${currentStep === 9 ? 'active' : ''}`}>
                    <label>
                        <h3 className='ChartBotFormSpan_H3Tag'>How much do you want to borrow?</h3>
                        <p className='ChartBotFormSpan_PTag'>(estimate ok)</p>
                ...
                <span className={`ChartBotFormSpan ${currentStep === 14 ? 'active' : ''}`}>
                    <label>
                        <h3 className='ChartBotFormSpan_H3Tag'>Average Monthly Expenses</h3>
                        <p className='ChartBotFormSpan_PTag'>(estimate ok)</p>
                ...
                <span className={`ChartBotFormSpan ${currentStep === 15 ? 'active' : ''}`}>
                    <label>
                        <h3 className='ChartBotFormSpan_H3Tag'>Do you currently have an FHA Loan?</h3>
