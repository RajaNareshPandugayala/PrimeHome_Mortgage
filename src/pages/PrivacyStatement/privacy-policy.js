            ...
            <div className='purchaseBottomParent'>
                <div className='purchaseBottomBox'>
                    <div className='purchaseBottomLeftBox'>
                        <span className='purchaseBottomLeftContent'>Prime Home Mortgage, INC has created this privacy statement in order to demonstrate our firm commitment to privacy.</span>
                        ...
                        <span className='purchaseBottomLeftContent'>Where this site specifically asks for your personal information (for example to respond to requests for information or to register users for particular services), your personal information will only be collected by staff of Prime Home Mortgage, INC who have responsibility for responding to such requests or administrating such registrations.</span>
                        ...
                        <span className='purchaseBottomLeftContent'>These sites may on occasion provide links to other sites for your convenience or additional information. Prime Home Mortgage, INC is not responsible for any content or practices of these sites.</span>
